...
- Analyze:
  `https://youtube.com/shorts/2gyj5Koh7k8` and
  `https://youtube.com/shorts/bnN_4w8grco`.
- Trace the original long-form or earliest credible upload for each reference
  item where public evidence permits.
- Find at least ten actual viral-source candidates across YouTube long-form,
  YouTube Shorts, TikTok, Douyin, and Xiaohongshu.
...
- Record views, comments, upload date, originality likelihood, reupload
  restrictions, and risk. Use `확인 불가` for unavailable values.
- Select three candidates with 8-12 second cuts and preserve setup, action,
